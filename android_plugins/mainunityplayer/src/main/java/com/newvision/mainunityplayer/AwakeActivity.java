...
public class AwakeActivity extends Activity {
    ...
    String sr = WRITE_EXTERNAL_STORAGE +","+READ_PHONE_STATE+","+READ_EXTERNAL_STORAGE+","+CAMERA+","+ACCESS_COARSE_LOCATION+","+RECORD_AUDIO+","+READ_CONTACTS+","+CALL_PHONE;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            Intent intent = new Intent(this, MainUnityPlayer.class);
