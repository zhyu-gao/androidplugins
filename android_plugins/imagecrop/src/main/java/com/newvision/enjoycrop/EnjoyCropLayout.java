package com.newvision.enjoycrop;
...
import com.newvision.enjoycrop.core.IShape;
import com.newvision.enjoycrop.core.clippath.ClipPathCircle;
...
import com.newvision.enjoycrop.core.debug.L;
import com.newvision.enjoycrop.core.image.EnjoyImageView;
...
public class EnjoyCropLayout extends FrameLayout{
    ...
    public void setImage(Bitmap bitmap){
        if(bitmap.getWidth() >2000)
        {
            ...
            bitmap = sizeBitmap(bitmap,2000,2000*bitmap.getHeight()/bitmap.getWidth());
        }
        try
        {
    ...
    public Bitmap crop(){
      ...
      //  Bitmap newBitmap = Bitmap.createBitmap(bitmap,centerX,centerY,actuallyWidth,actuallyHeight);
        ...
        Bitmap lastbitmap = Bitmap.createScaledBitmap(saveBitmap,800,800,true);
        return lastbitmap;
