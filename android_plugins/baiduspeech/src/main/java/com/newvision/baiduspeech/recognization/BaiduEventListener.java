package com.newvision.baiduspeech.recognization;

import android.util.Log;

import com.baidu.speech.EventListener;
import com.baidu.speech.asr.SpeechConstant;
import com.newvision.baiduspeech.BaiduRecogizationCallBack;
...
public class BaiduEventListener implements EventListener {
    private final String TAG = "RecogEventAdapter";
    protected String currentJson;
    private IRecogListener listener;
    public BaiduEventListener()
    {
        listener = new BaiduRecogizationCallBack();
    }
    @Override
